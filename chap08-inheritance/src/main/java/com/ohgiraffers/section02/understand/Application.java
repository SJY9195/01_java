...
public class Application {
    public static void main(String[] args) {
        ...
        OldCar avante = new OldCar("H", 2000, "avante", "gasoline");
        OldCar sonata = new OldCar("H", 2100, "sonata", "gasoline");

        System.out.println("영업 사원 입사 ");

        Seller seller = new Seller("홍길동");

        Car[] cars = {porter, kona, ionic2, sonata, avante};    // 어떤자식이든 부모클래스배열에 넣어줄수있다.
        seller.sale(cars);

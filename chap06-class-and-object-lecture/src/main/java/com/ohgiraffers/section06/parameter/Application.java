...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("인자로 전달하는 r1의 값 : " + r1);  //기본 객체 호출은 toString이 된다. 하지만 우리는 RectAngle 클래스 에서 toString 메소드를 설정해줬기때문에 설정한 값이 나온다.
        ...
        pt.testVariableLengthArrayParameter("신사임당",new String[]{"테니스", "서예", "당구"});  //테니스, 서예, 당구라는 배열을 새로 만듬. new String[]을 새로 쳐줘야 한다.

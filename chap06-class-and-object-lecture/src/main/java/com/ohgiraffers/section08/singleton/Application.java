...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * singleton pattern 이란?     //신입땐 고려 잘 안함
        * 어플리케이션이 시작될 때 어떤 클래스가 최초 한 번만
        ...
        * 인스턴스를 생성하지 않고도 사용할 클래스의 멤버에 지정할 수 있다.  cf) 클래스의 멤버 = 클래스안에 있는 필드와 메소드이다.
        * 여러 인스턴스가 공유해서 사용할 목적의 공간이다.
        * 하지만 static 키워드의 남발은 유지보수와 추적이 힘든 코드를 작성하는
        * 피해야 할 방식이다. 명확한 목적이 존재하지 않는 이상 static 키워드 사용은 자제하는 게 좋다.

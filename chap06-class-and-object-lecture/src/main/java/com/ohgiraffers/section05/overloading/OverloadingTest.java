...
public class OverloadingTest {
    public static void main(String[] args) {
        ...
        * 이 때 동일한 기능의 메소드를 매개변수에 따라 다르게
        * 이름을 정의하면 복잡하고 관리하기가 매우 어려워진다.
        * 규모가 작은 프로그램의 경우는 정도가 덜 하지만, 규모가 거대해지면 메소드 또한 관리하기가 매우 어렵다.
        * 따라서 동일한 이름으로 다양한 종류의 매개변수에 따라 처리해야 하는 여러 메소드를 관리하기 위해
        * 사용하는 기술을 오버로딩 이라고 한다.
        * */
        System.out.println(); //오버로딩의 대표적 예시 println! 하나의 변수로 다양한 자료형을 나타내주고 있다!

        /*
        * 오버로딩의 조건
        * 동일한 이름을 가진 메소드의 파라미터 선언부에 매개변수의 타입, 갯수,
        * 순서를 다르게 작성하여 한 클래스 내에 동일한 이름의 메소드를 여러 개 작성할 수 있도록 한다.
    ...
    public void test(char test3){}
    public void test(String test4, char test5){}

    // public void test(){} // 시그니쳐가 동일
    // private void test(){} // 접근제한자는 시그니쳐 X

...
public class Application {
    public static void main(String[] args) {
        ...
        * 운영체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 있도록 만든
        * 인터페이스를 뜻한다.
        * 쉽게 말해서 우리가 구현할 수 없거나 구현하기 번거로운 기능들을
        * jdk를 설치하면 사용할 수 있도록 제공해놓은
        ...
        * */
        ...
        // 별도의 import 없이도 사용 할 수 있음.

        System.out.println("-7의 절대값 : " + (Math.abs(-7)));
        // System.out.println("-7의 절대값 : " + (java.lang.Math.abs(-7))); 굳이 이렇게 패키지를 다 적을 필요 없다.
        ...
        // 원하는 난수를 발생시키는 방법
        // Math.random() → 0~0.99999999999... 사이 값을 랜덤으로 생성

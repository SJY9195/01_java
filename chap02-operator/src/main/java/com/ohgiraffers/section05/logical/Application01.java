...
public class Application01 {
    ...
    *
    * 논리 연산자의 종류
    * 1. 논리 연결 연산자 : 두 개의 피 연산자를 가지는 이항 연산자이며, 연산자의
    * 결함 방향은 왼쪽에서 오른쪽이다. 두 개의 논리식을 판단하여 참과 거짓을 판단한다.
    * 1-1. && (AND 논리) : 두 개의 논리식 모두 참일 경우 참을 반환, 한 개라도 거짓일 경우 거짓을 반환하는 연산자이다.   거짓일 가능성이 높은걸 앞에 둬서 계산을 줄여주게 하면 좋다. or은 그 반대
    * 1-2. || (OR 논리) : 두 개의 논리식 중 하나라도 참일 경우 참을 반환,
    * 둘 다 모두 거짓인 경우 거짓을 반환하는 연산자이다.
    ...
    * */
        ...
        System.out.println("false 와 false 논리 and 연산 : " + (false && false));

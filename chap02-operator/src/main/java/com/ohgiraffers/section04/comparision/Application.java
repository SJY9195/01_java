...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*삼항 연산자의 예
        *int num1 = 1;
        *String result = (num1 > 0)? "양수" : "양수가 아님";
        ...
        */
        ...
        System.out.println("inum 과 inum2 가 같은지 비교 : " + (inum1 == inum2));
        ...
        System.out.println("ch1 과 ch2 가 같은지 비교 : " + (ch1 == ch2)); // 대응되는 아스키코드 값이 다르기 때문에 a와 A의 값이 다르다
        System.out.println("ch1 과 ch2 가 같지 않은지 비교 : " + (ch1 != ch2));
        ...
        // 문자열값 비교
        // 문자열도 ==, != 비교 가능하지만, 대소 비교는 불가능하다. (메모리에서 미리 할당된 값을 꺼내오는 개념이므로 대소비교 불가)
        ...
        System.out.println("str1 과 str2 가 같지 않은지 비교 : " + (str1 != str2));

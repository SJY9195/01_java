...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 데이터 형 변환
        * 데이터 형 변환이 필요한 이유
        * - 자바에서 다른 타입 끼리의 연산은 피 연산자들이 모두 같은 타입이 되어야 실행 될 수 있다.
        ...
        *   2-1. 자동형변환이 적용되지 않는 경우에는 강제형변환이 필요하다.
        * */
        ...
        // 정수는 실수로 자동 형변환된다.
        // 정수를 실수로 변경할 때 소수점 자리가 없어도 실수형태로 표현가능하다.
        ...
        char chValue = (char)charNumber; // 숫자를 바로 넣을때는 (char)를 안넣어도 된다.  어려운개념

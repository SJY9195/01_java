...
public class Application03 {
    public static void main(String[] args) {
        ...
        // 동일한 범위(스코프) 내에서는 동일한 변수명을 가질 수 없다.
        int age = 20;
        // int age = 10;
        ...
        // 변수명은 숫자로 시작할 수 없다.
        // int 1test = 10;
        int te1st = 10; // 중간에 숫자가 들어가면 상관은 없다. 맨 앞에만 들어가지 않으면 된다.

        // 특수기호는 '_' 랑 '$' 만 사용이 가능하다.
        int _a_g_e_ = 10;
        int $t$e$s$t = 10;
        // int #test = 20;
         ...
         * 2-3. 단어와 단어 사이의 연결은 언더스코어(_)로 하지 않는다. (타 언어 규칙) (snake-case)
        ...
        // 변수명의 길이 제한은 없다.
        int oakwoekfowkofkweokkawwkfweofkl;

        // 변수명이 합성어로 이루어진 경우 첫 단어는 소문자. 두번째 시작 단어는 대문자. (camel-case)
        int maxAge = 10;
        int MaxAge = 10;
        ...
        // 명사형으로 작성할 수 있도록 한다.
        String goHome; // 가능하지만 되도록이면 명사형으로 짓는다.
        String home;

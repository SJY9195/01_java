...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 변수를 사용하는 방법
        * 1. 변수를 준비한다. - 선언
        * 2. 변수에 값을 대입한다. - 초기화 ( = 연산자는 대입한다는 뜻) (앞, 뒤 같은지 확인하려면 ==)
        * 3. 변수를 사용한다.
        *
        * */
        ...
        * 하나의 값으로 취급하겠다는 약속이다.
        * 이러한 자료형은 기본자료형(프리미티브 타입), 참조자료형(레퍼런스 타입) 으로 나누어 진다.
        * 그 중 기본 자료형 8가지를 먼저 확인한다.
        * */

        System.out.println("----------------");
        //목차 1-1 숫자를 취급하는 자료형
        // 1byte 는 8개의 bit 가 모여진 데이터 단위이다. (1bit는 0또는 1로 구성된다.)
        ...
        char ch; // 2byte
        System.out.println((char) 97);    //97을 a로 형 변환을 시켜준것

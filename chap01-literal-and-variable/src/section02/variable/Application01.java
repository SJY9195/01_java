...
public class Application01 {
    public static void main(String[] args) {
        ...
        *
        * 변수의 사용 목적
        * 1. 값의 의미를 부여하기 위한 목적(의미 전달이 쉬워야 코드를 읽기 쉬워지고,
        * 협업 및 유지보수에 유리하기 때문이다.)
        *
        * 2. 한 번 저장해 둔 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면
        *  값을 변경할 때도 보다 간편하게 변경 할 수 있다.)
        *
        ...
        * */
        ...
        /*수정*/  /* java의 terminal에 git add . , git commit -m "message", git push 입력하면
        자동으로 수정되서 깃헙에 올라간다.*/
    }    ///집에서 복습할 때 경로를 위한 clone 생성 cmd에서 git clone git hub의 주소 복사 ex) git clone https://github.com/SJY9195/01_java.git
}

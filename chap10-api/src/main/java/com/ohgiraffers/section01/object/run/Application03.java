...
public class Application03 {
    public static void main(String[] args) {
        ...
        * euqals() 메소드를 재정의 하는 경우 반드시 hashCode()도
        * 재정의 하도록 되어 있다.
        ...
        * */
        ...
        map.put(new Book(1, "홍길동전", "허균", 50000), "selled"); //1, 홍길동전, 허균, 50000이 키 값 (제목) , selled가 밸류 값 (내용)

        String str = map.get(new Book(1,"홍길동전","허균", 50000)); // 주의) 동등객체이므로 오버라이드를 해줘야 값을 찾을 수 있다!!

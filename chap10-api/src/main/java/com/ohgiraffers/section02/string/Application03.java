...
public class Application03 {
    public static void main(String[] args) {
        ...
        * */
        ...
        String[] empArr1 = emp1.split("/");  // split은 쪼개갖고 배열에 넣는 다는것!!
        ...
        String[] empArr4 = emp3.split("/", -1);  // 뒤의 인자는 몇개로 쪼갤지에 대한 숫자이다. (음수는 공백포함해서 무조건 끝까지 쪼개진다!)
        ...
        while(st3.hasMoreTokens()){
            System.out.println("st3 : " + st3.nextToken());   //split은 공백을 무시하지만, StringTokenizer는 공백을 무시를 안한다.
        }

        String colorStr = "red*orange#blue/yello green";
        // String[] colors = colorStr.split("*#"); //split은 정규표현식을 사용하기 때문에 이런식으로 못쓴다.
        StringTokenizer colorStringTokenizer = new StringTokenizer(colorStr, "*#/ "); //그러나 StringTokenizer는 가능하다.

...
public class Application01 {
     ...
     * */
        ...
        * 두 문자열이 같다면 0 을 반환, 인자로 전달된 문자열보다 작으면 음수를, 크면 양수를 반환한다.
        ...
        * */
        System.out.println("lastIndexOf() : " + (indexOf.lastIndexOf("a")));
        System.out.println("lastIndexOf() : " + (indexOf.lastIndexOf("z")));

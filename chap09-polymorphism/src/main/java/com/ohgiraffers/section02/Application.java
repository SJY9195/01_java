...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * 추상 클래스와 추상 메소드
        * 추상 메소드를 1개 이상 포함하는 클래스를 추상클래스 라고 한다.
        * 추상클래스는 선언부에 abstract(추상적인) 키워드를 명시해야 한다.
        * 추상클래스로는 인스턴스를 생성할 수 없다.
        * 추상클래스를 사용하려면 추상 클래스를 상속 받은 하위 클래스에서
        * 인스턴스를 생성해야 한다.
        * 이 때 추상 클래스는 상위 타입으로 사용될 수 있으며, 다형성을 이용할 수 있다.
        *
        * 추상클래스에 작성한 메소드는 반드시 오버라이딩 해서 작성하며
        * 후손 클래스들의 메소드들의 공통 인터레이스 역할을 수행할 수 있다.
        * 추상 클래스에 작성한 메소드를 호출하게 되면 실제 후손 타입의 인스턴스가 가지는 메소드는 다형성이 적용되어
      ...
      //  Product product = new Product();
        ...
        *
        * 하지만 다른 클래스를 상속 받고 클래스를 작성할 시에는
        * 추상클래스를 추가로 상속받을 수 없다.
        * 그래서 추상클래스보다 더 강제성이 강한 인터페이스라는 메커니즘을 제공하고 있다.
        * */

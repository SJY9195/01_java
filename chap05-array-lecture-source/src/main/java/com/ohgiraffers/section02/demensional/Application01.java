...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*iarr2 = new int[][];
        iarr2 = new int[][3];*/  //주소를 관리할 배열 (앞 대괄호)의 크기를 지정하지 않으면 에러가뜨므로 꼭 지정해 둬야 한다.
 ...
 /*
        ...
        for (int i = 0; i < iarr1.length; i++) {    //iarr1.length 는 위에서 iarr1[0] = new int[5]로 배열의 길이를 초기화 시켜준것.
            // [0]의 배열 길이는 뒤의 대괄호인 [5]가 된다! cf)[0]은 뒤의 배열의 인덱스를 불러주는 역할을 해준다. [0]은 0뒤의 인덱스 주소를 만들어 준다는 의미!

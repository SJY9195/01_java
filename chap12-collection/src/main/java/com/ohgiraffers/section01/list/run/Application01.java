...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 배열은 크기를 변경할 수 없고, 요소의 추가, 삭제, 정렬이 복잡하다는 단점을 가지고 있다.
        ...
        * */
        ...
        ArrayList alist = new ArrayList(); // 기본적으로 10칸짜리 배열이 생성된다! 주소값이 달라지게 생성된다!

        List list = new ArrayList(); //List에 정의되어있는게 많기 때문에 주로 많이 쓴다!! 밑에 Collection은 '이렇게도 가능하다' 정도만 알고 있으면 된다!
        // list = new LinkedList();
        ...
        * */
        ...
        System.out.println("stringList = " + stringList);   //오름차순으로 구현된다.
